...
from hcsr04 import HCSR04 #Distance sensor HCSR04
...
MY_NAME = const("Javier")              # The user name/handle
...
def usb_scan_and_parse(cmd_echo = True):
    ...
    if usb.poll(0):                    # Check if there is any USB data available
        ...
        # Read the distance rd distance
        elif string == "rd distance":
            read_distance()
        ...
        # Print help text
            ...
            print("rd distance               to read distance")
...
#                 lcd.print_broadcast(msg[1:21].ljust(20)) # Remove broadcast *, and only print the first 20 chars, fill rest with blanks
